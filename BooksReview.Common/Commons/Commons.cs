...
namespace BooksReview.Commons
{
    public static class Commons
    {
        ...
        static public string ConvertPascalToLowerCase(this object input)
        {
            // Tách chuỗi dựa vào ký tự viết hoa và thay thế bằng _
            string separatedWords = Regex.Replace(input.ObjToStr().ToString(), "(\\B[A-Z])", "_$1");
